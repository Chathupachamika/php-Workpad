...
<body class="bg-gray-100 p-6">
    <div class="container mx-auto max-w-md">
        ...
        <!-- Form -->
        <form method="POST" action="<?php echo e(route('product.store')); ?>" class="form-container">
            <?php echo csrf_field(); ?>
...
<?php /**PATH E:\laravel\git repo\crud-laravel\resources\views/products/create.blade.php ENDPATH**/ ?>